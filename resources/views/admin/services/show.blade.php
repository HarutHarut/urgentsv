            ...
            <div class="card-body">
                <form action="{{ route($route.'-admin-update', ['locale' => app()->getLocale(), 'id' => $item->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor5" rows="3" class="form-control mb-2" name="description_en" min="1" placeholder="English" required>{!! nl2br(e($item->description_en)) !!}</textarea>
                        <textarea class="ckeditor5" rows="3" class="form-control mb-2" name="description_ru" min="1" placeholder="Русский" required>{!! nl2br(e($item->description_ru)) !!}</textarea>
                        <textarea class="ckeditor5" rows="3" class="form-control mb-2" name="description_fr" min="1" placeholder="France" required>{!! nl2br(e($item->description_fr)) !!}</textarea>
                    </div>
