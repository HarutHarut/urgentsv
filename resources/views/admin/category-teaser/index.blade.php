                        ...
                        <tbody>
                           @foreach($items as $key => $item)
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $item->title_en }}</td>
                                <td><a href="{{ route('menu-admin-show', ['locale' => app()->getLocale(), 'currency' => 'amd', 'id' => $item->category_id]) }}" target="_blank">{{ $item->category['title_en'] }}</a></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select form="add-new-item" name="category_id" class="form-control" required>
