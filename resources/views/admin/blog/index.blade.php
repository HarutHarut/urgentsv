    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <textarea rows="7" form="add-new-item" class="form-control mb-2" name="description_en" placeholder="English"></textarea>
                <textarea rows="7" form="add-new-item" class="form-control mb-2" name="description_ru" placeholder="Русский"></textarea>
                <textarea rows="7" form="add-new-item" class="form-control mb-2" name="description_hy" placeholder="Հայերեն" required></textarea>
            </div> 

            <!-- URL -->
            <div class="form-group">
                <label>URL</label>
                <input type="text" form="add-new-item" class="form-control mb-2" name="url" required>
            </div>

            <!-- Position ID -->
            <div class="form-group">
                <label>Position ID</label>
                <input type="number" form="add-new-item" class="form-control mb-2" value="1" name="position_id" required>
            </div>
