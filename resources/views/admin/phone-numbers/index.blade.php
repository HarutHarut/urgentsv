...
<div class="modal fade" id="addNewItem" tabindex="-1" role="dialog" aria-labelledby="addNewItemLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="addNewItemLabel"><a href="https://en.wikipedia.org/wiki/ISO_3166-2:FR" target="_blank">Link</a></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" form="add-new-item" class="form-control mb-2" name="location" max="255" min="1" required placeholder="City Code">
                <input type="text" form="add-new-item" class="form-control mb-2" name="phone" max="255" min="1" required placeholder="Phone">
            </div>   
