...
class TermsAndConditionsItemsController extends Controller
{
    // Admin Validation
    ...
    public function index(Request $request)
    {
        ...
        // Get items
        $items = TermsAndConditionsItems::orderBy('id','desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        // Make data
        $item = new TermsAndConditionsItems;
     ...
     *
     * @param  \App\TermsAndConditionsItems  $termsAndConditionsItems
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, $locale = 'hy', $id)
    {
        ...
        // Get item
        $item = TermsAndConditionsItems::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(TermsAndConditionsItems $termsAndConditionsItems)
    {
        //
    }
    ...
    public function update(Request $request, $locale = 'hy', $id)
    {
        ...
        // Update
        TermsAndConditionsItems::findOrFail($id)->update($item);
    ...
    {
        // Delete from itmes
        TermsAndConditionsItems::findOrFail($id)->delete();
