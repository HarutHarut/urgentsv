    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label>Title</label>
                <input type="text" form="add-new-item" class="form-control mb-2" name="title_en" max="255" min="1" placeholder="English" required>
                <input type="text" form="add-new-item" class="form-control mb-2" name="title_ru" max="255" min="1" placeholder="Русский" required>
            ...
            <div class="form-group">
                <label>URL</label>
                <input type="text" form="add-new-item" class="form-control mb-2" name="url" max="255" min="1" placeholder="URL" required>
            </div>
