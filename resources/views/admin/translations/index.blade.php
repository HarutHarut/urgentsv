    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" form="add-new-item" class="form-control mb-2" name="selector" max="255" min="1" placeholder="Selector" required>
            </div>
            <div class="form-group">
                <label>Translation</label>
                <textarea rows="5" form="add-new-item" class="form-control mb-2" name="translation" max="99999" min="1" placeholder="Translation" required></textarea>
            </div>
            <div class="form-group">
                <label>Localization</label>
                <select form="add-new-item" class="form-control mb-2" name="locale" required>
