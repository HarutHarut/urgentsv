...
class SocialAccountsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get items
        $items = SocialAccounts::orderBy('id','desc')->get();
     ...
     *
     * @param  \App\SocialAccounts  $socialAccounts
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, $locale = 'hy', $id)
    {
        ...
        // Get item
        $item = SocialAccounts::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SocialAccounts $socialAccounts)
    {
        //
    }
