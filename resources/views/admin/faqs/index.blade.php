    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" form="add-new-item" class="form-control mb-2" name="question_en" max="255" min="1" placeholder="English">
                <input type="text" form="add-new-item" class="form-control mb-2" name="question_ru" max="255" min="1" placeholder="Русский">
                <input type="text" form="add-new-item" class="form-control mb-2" name="question_hy" max="255" min="1" placeholder="Հայերեն" required>
            </div>   
            
            <!-- Answer -->
            <div class="form-group">
                <label>Answer</label>
                <textarea rows="3" form="add-new-item" class="form-control mb-2" name="answer_en" min="1" placeholder="English"></textarea>
                <textarea rows="3" form="add-new-item" class="form-control mb-2" name="answer_ry" min="1" placeholder="Русский"></textarea>
                <textarea rows="3" form="add-new-item" class="form-control mb-2" name="answer_hy" min="1" placeholder="Հայերեն" required></textarea>
            </div>
