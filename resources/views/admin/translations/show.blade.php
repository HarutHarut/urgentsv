            ...
            <div class="card-body">
                <form action="{{ route($route.'-admin-update', ['locale' => app()->getLocale(), 'currency' => 'amd','id' => $item->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control mb-2" name="translation" max="99999" min="1" placeholder="Translation" required>{{ $item->translation }}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control mb-2" name="locale" required>
                            ...
                            <option value="fr" @if( $item->locale == 'fr' ) selected @endif>France</option>
                        </select>
                    </div>
