...
<div class="modal fade" id="addNewItem" tabindex="-1" role="dialog" aria-labelledby="addNewItemLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label>Service</label>
                <select form="add-new-item" class="form-control mb-2" name="service_id">
                    @if(isset($services) && count($services) > 0)
                        @foreach($services as $service)
                            <option value="{{ $service->id }}">{{ $service->{'title_fr'} }}</option>
                        @endforeach
                    @endif
                </select>
            </div>   
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label>Price</label>
                <input type="text" form="add-new-item" class="form-control mb-2" name="price" max="255" min="1" placeholder="Price">
            </div>
