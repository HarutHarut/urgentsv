    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label>Title</label>
                <input type="text" form="add-new-item" class="form-control mb-2" name="title_fr" max="255" min="2" placeholder="English">
                <input type="text" form="add-new-item" class="form-control mb-2" name="title_ru" max="255" min="2" placeholder="Русский">
                <input type="text" form="add-new-item" class="form-control mb-2" name="title_fr" max="255" min="2" placeholder="France" required>
            </div>
            <div class="form-group">
                <label>Description</label>
                <textarea rows="6" form="add-new-item" class="form-control mb-2" id="description_en" name="description_en" max="99999" min="2" placeholder="English"></textarea>
                <textarea rows="6" form="add-new-item" class="form-control mb-2" id="description_ru" name="description_ru" max="99999" min="2" placeholder="Русский"></textarea>
