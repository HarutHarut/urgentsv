...
class CodeDeConduiteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get page name
        $page_name = 'Code de Conduites Items';

        // Get items
        $items = CodeDeConduite::orderBy('id','desc')->get();
     ...
     *
     * @param  \App\CodeDeConduite  $CodeDeConduite
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, $locale = 'hy', $id)
    {
        ...
        // Get page name
        $page_name = 'Code de Conduites Items / Update';

        // Get item
        $item = CodeDeConduite::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(CodeDeConduite $CodeDeConduite)
    {
        //
    }
    ...
    public function update(Request $request, $locale = 'hy', $id)
    {
        ...
        // Update
        CodeDeConduite::findOrFail($id)->update($item);
    ...
    {
        // Delete from itmes
        CodeDeConduite::findOrFail($id)->delete();
