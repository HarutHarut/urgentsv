        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 home-banner-left-column">
                    ...
                    <h1 class="mb-4">Your <span class="text-gradient">trusted partner</span> in emergency situations.</h1>
                    <p><span class="text-primary">Urgent svc is an 24/7 emergency company,</span> offering highly qualified services (plumbers, electricians, boiler or locksmiths) for individuals, offices and businesses.</p>
