        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 home-banner-left-column">
                    ...
                    <h1 class="mb-4">{{ translating('fast_reliable_home_services') }}</h1>
                    <p>{{ translating('from_urgent_repairs') }}</p>
                    <p class="text-primary mt-3">{{ translating('wait_get_the_help') }}</p>
                    <a href="/{{app()->getLocale()}}/contacts" class="contacts-btn my-4">
                        {{ translating('get_immediate_assistance') }}
