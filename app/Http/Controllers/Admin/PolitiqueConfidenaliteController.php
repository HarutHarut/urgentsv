...
class PolitiqueConfidenaliteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get items
        $items = PolitiqueConfidenalite::orderBy('id','desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        // Make data
        $item = new PolitiqueConfidenalite;
     ...
     *
     * @param  \App\PolitiqueConfidenalite  $PolitiqueConfidenalite
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, $locale = 'hy', $id)
    {
        ...
        // Get page name
        $page_name = 'Privacy Policy / Update';

        // Get item
        $item = PolitiqueConfidenalite::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(PolitiqueConfidenalite $PolitiqueConfidenalite)
    {
        //
    }
    ...
    public function update(Request $request, $locale = 'hy', $id)
    {
        ...
        // Update
        PolitiqueConfidenalite::first()->update($item);
    ...
    {
        // Delete from itmes
        PolitiqueConfidenalite::findOrFail($id)->delete();
