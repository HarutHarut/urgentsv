                ...
                <div class="services-grid">
                    @foreach($servicesList as $service)
                        <div class="service-block">
                            <img src="{{ $image_path }}/service/img/{{ $service['img'] }}" class="service-main-image" alt="{{ $service['title'] }}" />
                            <div class="white-overlay"></div>
                            <div class="position-relative zmdi-500px">
                                <div class="service-icon">
                                    <img src="{{ $image_path }}/service/{{ $service['icon'] }}" alt="{{ $service['title'] }}">
                                </div>
                                <h6>{{ $service['title'] }}</h6>
                    ...
                    <div class="service-contact-block">
                        <div>
                            ...
                            <p>{{ translating('need_a_help_from_urgent') }}<br>{{ translating('call_us_today_for_a_quick') }}</p>
...
{{--                    <div>--}}
{{--                        <p class="footer-top-block-title">{{ translating('get_in_touch_today') }}</p>--}}
{{--                        <p class="footer-top-block-desc">{{ translating('whether_you_need_immediate') }}</p>--}}
{{--                    </div>--}}
{{--                    <a href="tel:0525680425">--}}
{{--                        {{ translating('call_us') }} 0525680452--}}
{{--                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
