...
class ServicesItemsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get page name
        $page_name = 'Services Items';

        // Get items
        $items = ServicesItems::orderBy('id','desc')->get();
     ...
     *
     * @param  \App\ServicesItems  $servicesItems
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, $locale = 'hy', $id)
    {
        ...
        // Get page name
        $page_name = 'Services Items / Update';

        // Get item
        $item = ServicesItems::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ServicesItems $servicesItems)
    {
        //
    }
    ...
    public function update(Request $request, $locale = 'hy', $id)
    {
        ...
        // Save data
        ServicesItems::findOrFail($id)->update($item);
    ...
    {
        // Delete from itmes
        ServicesItems::findOrFail($id)->delete();
