<div class="container" style="margin-top: 48px;">
    <div class="text-center">
        <h2><span class="text-gradient">What Our Customers Say</h2>
        <p class="section-desc mt-4">We pride ourselves on delivering top-notch service. Here’s what some of our satisfied customers have to say.</p>
    </div>
    ...
    <div class="text-center">
        <h2><span class="text-gradient">Our Achievements</h2>
        <p class="section-desc mt-4">We’ve successfully completed thousands of service calls, earning the trust of homeowners across Toulouse.</p>
    </div>
